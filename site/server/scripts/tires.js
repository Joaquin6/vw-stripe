...
require( "../images/tires/Tires_ATV.jpg" );
require( "../images/tires/Tires_GOLF.jpg" );
require( "../images/tires/Tires_LG.jpg" );
require( "../images/tires/Tires_TRAILER.jpg" );
require( "../styles/tires.scss" );
(function() {
	console.log( "===== Closure =====" );
